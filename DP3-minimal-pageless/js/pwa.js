...
function albums(j){  //returns all photos in a specific album
 ...
 $("<div style='margin-left:3px'><a class='standard' href='" + window.location.protocol + "//" + window.location.hostname+window.location.pathname+"'>Gallery Home</a> &rsaquo; "+ j.feed.title.$t +"&nbsp;&nbsp;["+np+" item"+item_plural+"]</div><div style='text-align:right; margin-right:5px; margin-top:-14px'><a target=PICASA class='standard' href='"+album_link+"'>View this album in Picasa</a></div><br>");
 $("<table border=0><tr>");
...
$("<div style='margin-left:3px'><a class='standard' href='"+ window.location.protocol + "//" + window.location.hostname+window.location.pathname+"'>Gallery Home</a> &rsaquo; <a class='standard' href='" + album_base_path + "'>" + my_fixed_galleryname + "</a> &rsaquo; <!--" + img_filename + "-->" + current_index_text + "</div><div style='text-align:right; margin-right:3px; margin-top:-14px'><a target=PICASA class='standard' href='"+photo_link+"'>View this image in Picasa</a></div><br>");
...
if (n1 == null) //we're at the last picture in the album; going forward takes us to the album index
 ...
 if (photo_array.length > 1) { $("<td><a class='standard' href='"+prev+"'><img class='nostyle' border=0 alt='Previous item' src='http://manda-moore.com/user/themes/Minimal_Pageless/images/next.gif'></a> </td><td></td>"); }
 $("<td> <a class='standard' href='"+album_base_path+"'><img class='nostyle' border=0 alt='Back to album index' src='http://manda-moore.com/user/themes/Minimal_Pageless/images/home.gif'></a> </td>");
 if (photo_array.length > 1) { $("<td></td><td> <a class='standard' href='"+next+"'><img class='nostyle' border=0 alt='Next item' src='http://manda-moore.com/user/themes/Minimal_Pageless/images/prev.gif'></a></td>"); }
 $("</tr></table></center><br>");
