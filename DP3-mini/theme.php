...
/**
	...
	public function add_template_vars()
	{
		...
		// Add a copyright notice option
		$copyright = Options::get( 'colourful__copyright_notice' );
		
		if ( $copyright == null ) {
			$copyright = '&copy; Copyright ' . date('Y') . '.';
		}
		else {
			$copyright = str_replace( '%year', date('Y'), $copyright );
		}
		$this->assign( 'copyright', $copyright );
		// end copyright notice option
 ...
 */
	...
	// Let theme know it's configurable
	...
	/**
	 * Actual user-end configuration items
	 */
	 
	
	public function action_theme_ui()
	{
		$form = new FormUI( 'colourful_theme' );
		
		// Configure copyright
		$copyright_notice = $form->append('text', 'copyright_notice', 'colourful__copyright_notice', _t( 'Copyright Notice') );
