<!-- rename this form to commentform.php for use with habari versions .7.x and higher to make sure commenting works properly -->
<!-- if using with habari versions .6.x and previous, please rename this file to something else -->
